...
internal sealed class BeerQueries(IMongoClient mongoClient) : IQueries<Beer>
{
    ...
    public async Task<Result<PagedResult<Beer>>> GetByFilterAsync(Expression<Func<Beer, bool>>? query, int page,
