...
public sealed class DoNotAuthorizePaymentTwice
    : CommandSpecification<RecordPaymentAuthorized>
{
    ...
    private readonly Guid _firstAuthorizationCorrelationId = Guid.CreateVersion7();
    ...
    protected override IEnumerable<DomainEvent> Given()
    {
        ...
        yield return new PaymentAuthorized(
            _id,
            "provider-auth-123",
            _firstAuthorizationCorrelationId);
    }
