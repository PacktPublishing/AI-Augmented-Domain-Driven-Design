...
public sealed class ConfirmIsIdempotent : CommandSpecification<ConfirmSalesOrder>
{
    ...
    {
        // The order was already created and previously confirmed.
    ...
    {
        // Idempotent: no second SalesOrderConfirmed raised.
        yield break;
    }
}
