candidates:
  ...
  - id: ST-04
    kind: scenario
    name: pale ale is genuinely out until Thursday
    ...
    status: unresolved
    decision_owner: unknown
    uncertainty: "The evidence identifies the temporary stock problem but does not establish that the expected beer arrives or that the response tells Sales to wait."
  ...
  - id: ST-10
    kind: scenario
    name: Sales sends a held order through to shipping
    ...
    status: unresolved
    decision_owner: Sales
    uncertainty: "Sales owns the decision that the order goes through, but the evidence does not identify its other conditions, how shipping receives authority, who books the van, or how much time passes."
    review_question: "Which Sales authority releases the order, what message authorizes shipping, and when should the shipping lads collect the held beer?"
