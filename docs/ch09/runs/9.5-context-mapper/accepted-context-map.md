# Context Mapper 9.5 — Draft Effective Candidate Handoff

**Status: pending human gate — not yet authoritative input.**

This file is a convenience projection of the 12 reference candidates so the intended 9.5 repository shape can be reviewed. It must not be treated as an accepted handoff until `human-decision.md` records the human gate.

## Provenance

- Reference output SHA-256: `567ffe9b06794160ecb53c45a3e452a077c11ed5019deb2dbc409783b308cc43`
- Human decision: `pending`
- Reference classification: authoring reference; not primary experimental evidence
